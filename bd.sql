...
--
  -- Database: `s_horte`
  --
  CREATE DATABASE IF NOT EXISTS `sys_horta` DEFAULT CHARACTER SET utf8 COLLATE utf8_bin;
USE `sys_horta`;
-- --------------------------------------------------------
  --
...
-- --------------------------------------------------------
  ...
  --
  CREATE TABLE `test` (`entrada` text COLLATE utf8_bin NOT NULL) ENGINE = InnoDB DEFAULT CHARSET = utf8 COLLATE = utf8_bin;
--
